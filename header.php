...
<h1 class="header__logo-ttl"><a href="<?php echo $home; ?>">トイレつまり<br class="d-md-none">修理業者の比較サイト<?php if (is_front_page() || is_home() || is_tax()):?><span><?php echo $pref; ?></span><?php endif; ?></a></h1>
</div>
</div>
</header>
<!-- ヘッダー終了 -->
