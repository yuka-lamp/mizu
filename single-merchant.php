...
<!-- menu1 -->
<?php if (get_field('merchant_work_after_1')): ?>
...
<div class="carousel-item active"><img src="<?php the_field('merchant_work_after_1'); ?>" alt=""></div>
</div>
</div>
<!-- case1 -->
...
<div class="carousel-inner">
<div class="carousel-item active"><img src="<?php the_field('merchant_work_after_2'); ?>" alt=""></div>
</div>
</div>
<!-- case2 -->
...
<div class="carousel-inner">
<div class="carousel-item active"><img src="<?php the_field('merchant_work_after_3'); ?>" alt=""></div>
</div>
</div>
<!-- case3 -->
...
let radar_chart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      borderWidth: 1,
      borderColor: 'rgb(59, 148, 216)',
      pointBackgroundColor: 'rgb(59, 148, 216)',
      backgroundColor: 'rgba(59, 148, 216, 0.6)'
    }],
  },
  options: {
      title: {
